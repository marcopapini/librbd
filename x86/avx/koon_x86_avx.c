...
static __m128d rbdKooNRecursiveStepV2dAvx(struct rbdKooNGenericData *data, unsigned int time, unsigned char n, unsigned char k);
...
/**
 * rbdKooNGenericSuccessStepV2dAvx
 *
 * Generic KooN RBD Step function from working components with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNGenericData *data
 *      unsigned int time
 ...
 *
 * Description:
 *  This function implements the generic KooN RBD function exploiting x86 AVX 128bit.
 *  It is responsible to compute the reliability of a KooN RBD system
 *  taking into account the working components
 *
 * Parameters:
 ...
 *  None
 */
__attribute__((visibility ("hidden"))) void rbdKooNGenericSuccessStepV2dAvx(struct rbdKooNGenericData *data, unsigned int time)
{
    __m128d v2dStep;
    __m128d v2dTmp;
    __m128d v2dRes;
...
/**
 * rbdKooNGenericFailStepV2dAvx
 *
 * Generic KooN RBD Step function from failed components with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNGenericData *data
 *      unsigned int time
 ...
 *  None
 */
__attribute__((visibility ("hidden"))) void rbdKooNGenericFailStepV2dAvx(struct rbdKooNGenericData *data, unsigned int time)
{
    __m128d v2dStep;
    __m128d v2dTmp;
    __m128d v2dRes;
...
/**
 * rbdKooNRecursionV2dAvx
 *
 * Compute KooN RBD though Recursive method with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNGenericData *data
 *      unsigned int time
 ...
 *  None
 */
__attribute__((visibility ("hidden"))) void rbdKooNRecursionV2dAvx(struct rbdKooNGenericData *data, unsigned int time)
{
    __m128d v2dRes;

    /* Recursively compute reliability of KooN RBD at current time instant */
    v2dRes = rbdKooNRecursiveStepV2dAvx(data, time, data->numComponents, data->minComponents);
    /* Cap the computed reliability and set it into output array */
    _mm_storeu_pd(&data->output[time], capReliabilityV2dAvx(v2dRes));
}
 ...
 *
 * Identical KooN RBD Step function from working components with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNIdenticalData *data
 *      unsigned int time
 ...
 *
 * Description:
 *  This function implements the identical KooN RBD function exploiting x86 AVX 128bit.
 *  It is responsible to compute the reliability of a KooN RBD system
 *  taking into account the working components
 *
 * Parameters:
 ...
 *  None
 */
__attribute__((visibility ("hidden"))) void rbdKooNIdenticalSuccessStepV2dAvx(struct rbdKooNIdenticalData *data, unsigned int time)
{
    __m128d v2dR;
 ...
 *
 * Identical KooN RBD Step function from failed components with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNIdenticalData *data
 *      unsigned int time
 ...
 *  None
 */
__attribute__((visibility ("hidden"))) void rbdKooNIdenticalFailStepV2dAvx(struct rbdKooNIdenticalData *data, unsigned int time)
{
    __m128d v2dU;
    __m128d v2dTmp1, v2dTmp2;
    __m128d v2dRes;
...
/**
 * rbdKooNRecursiveStepV2dAvx
 *
 * Recursive KooN RBD Step function with x86 AVX 128bit
 *
 * Input:
 *      struct rbdKooNGenericData *data
 *      unsigned int time
 ...
 *
 * Description:
 *  This function implements the recursive KooN RBD function exploiting x86 AVX 128bit.
 *  It is responsible to recursively compute the reliability of a KooN RBD system
 *
 * Parameters:
 *      data: KooN RBD data structure
...
static __m128d rbdKooNRecursiveStepV2dAvx(struct rbdKooNGenericData *data, unsigned int time, unsigned char n, unsigned char k)
{
    ...
    /* Recursively compute the reliabilities */
    if ((k-1) > 0) {
        v2dTmp2 = rbdKooNRecursiveStepV2dAvx(data, time, n, k-1);
        v2dRes = _mm_mul_pd(v2dRes, v2dTmp2);
    }
    if (k <= n) {
        v2dTmp2 = rbdKooNRecursiveStepV2dAvx(data, time, n, k);
        v2dTmp1 = _mm_mul_pd(v2dTmp1, v2dTmp2);
        v2dRes = _mm_add_pd(v2dRes, v2dTmp1);
    }
    return v2dRes;
