 ...
 *
 * Generic Parallel RBD step function with x86 AVX 128bit
 *
 * Input:
 *      struct rbdParallelData *data
 *      unsigned int time
 ...
 *
 * Description:
 *  This function implements the generic Parallel RBD step exploiting x86 AVX 128bit.
 *  It is responsible to compute the reliability of a Parallel block with generic components
 *  given their reliabilities
 *
 * Parameters:
 ...
 *      time: current time instant over which Parallel RBD shall be computed
 */
__attribute__((visibility ("hidden"))) void rbdParallelGenericStepV2dAvx(struct rbdParallelData *data, unsigned int time)
{
    unsigned char component;
    __m128d v2dTmp;
    __m128d v2dRes;
 ...
 *
 * Identical Parallel RBD step function with x86 AVX 128bit
 *
 * Input:
 *      struct rbdParallelData *data
 *      unsigned int time
 ...
 *
 * Description:
 *  This function implements the identical Parallel RBD step exploiting x86 AVX 128bit.
 *  It is responsible to compute the reliability of a Parallel block with identical components
 *  given their reliability
 *
 * Parameters:
 ...
 *      time: current time instant over which Parallel RBD shall be computed
 */
__attribute__((visibility ("hidden"))) void rbdParallelIdenticalStepV2dAvx(struct rbdParallelData *data, unsigned int time)
{
    unsigned char component;
    __m128d v2dU;
    __m128d v2dRes;
