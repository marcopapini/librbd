...
void rbdSeriesGenericStepVNdSve(svbool_t pg, struct rbdSeriesData *data, unsigned int time);
void rbdSeriesIdenticalStepVNdSve(svbool_t pg, struct rbdSeriesData *data, unsigned int time);
