 ...
 *
 * Generic Bridge RBD Worker function with amd64 AVX instruction set
 *
 * Input:
 ...
 *  NULL
 */
HIDDEN void *rbdBridgeGenericWorkerAvx(struct rbdBridgeData *data)
{
    unsigned int time;
 ...
 *  NULL
 */
HIDDEN void *rbdBridgeIdenticalWorkerAvx(struct rbdBridgeData *data)
{
    unsigned int time;
